package io.kafka.streams.wikimedia.processor;
...
public class EventCountStreamBuilder {
    private static final String TIMESERIES_TOPIC = "wikimedia.stats.timeseries";
    private static final String TIMESERIES_STORE = "wikimedia.stats.bots";
    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();

    private final KStream<String, String> inputStream;


    public EventCountStreamBuilder(KStream<String, String> inputStream) {
